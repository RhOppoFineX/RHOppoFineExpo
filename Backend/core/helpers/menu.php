...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="brand">
        <a href="index.html"><img src="assets/img/logo-ricaldone.png" alt="Klorofil Logo" class="img-responsive logo" width="100" height="100"></a>
    </div>
                ...
                <li>
                    ...
                    <div id="subPagesCruds" class="collapse ">
                        <ul class="nav"><!--Colaborador-->
                            ...
                            <li><a href="tables.html" class=""><i class="lnr lnr-dice"></i> <span>Identificación</span></a></li>
                            <li><a href="tables.html" class=""><i class="lnr lnr-dice"></i> <span>Familiares</span></a></li>
                            <li><a href="tables.html" class=""><i class="lnr lnr-dice"></i> <span>Educación</span></a></li>
