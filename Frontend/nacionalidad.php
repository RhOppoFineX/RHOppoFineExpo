...
<head>
    ...
    <title>Tabla |nacionalidad </title>
...
<body> <!--Indicaiones:
	...
	<div id="wrapper">
				...
				<div class="main">					
					<div class="main-content">
						<div class="container-fluid">
							<h3 class="page-title">Datos nacionalidad</h3>
							<div class="col-md-12">
                                <!-- TABLE STRIPED -->
							<div class="panel">
			...
			<!-- Modal Modificar-->
<div class="modal fade bd-modificar-modal-xl" id="nacionalidadModificar" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-scrollable" role="document">
		<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalScrollableTitle">Datos nacionalidad</h5>
		...
		<div class="modal-body">
			<div class="container-fluid">
					<form method="post" id="actualizarnacionalidad">
							<div class="form-group col-md-12">
								<!--nuevo input es invisible-->	<input type="hidden" id="id_nacionalidad" name="id_nacionalidad">	
									<label for="nacionalidad">nacionalidad</label>
									<input type="text" class="form-control" id="nacionalidad" aria-describedby="nacionalidadHelp" placeholder="nacionalidad" name="nacionalidad"><!--Agreguen los name="" mismo que el id-->
									<small id="nacionalidadHelp" class="form-text text-muted"></small>
...
<div class="modal fade bd-modificar-modal-xl" id="nacionalidadInsertar" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-scrollable" role="document">
		<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalScrollableTitle">Datos de nacionalidad</h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			<span aria-hidden="true">&times;</span>
			</button>
		</div>
		<div class="modal-body">
			<div class="container-fluid">
					<form method="post" id="insertarnacionalidad">
							<div class="form-group col-md-12">							
									<label for="nacionalidad">nacionalidad</label>
									<input type="text" class="form-control" id="nacionalidad" aria-describedby="nacionalidadHelp" placeholder="Religión" name="nacionalidad">
									<small id="nacionalidadHelp" class="form-text text-muted"></small>
							</div>
	...
	<script src="../Backend/core/controllers/nacionalidad.js"></script>
